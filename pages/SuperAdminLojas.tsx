  ...
  return (
    <div className="max-w-7xl mx-auto p-8 space-y-10">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          <h1 className="text-5xl font-black text-gray-900 tracking-tighter uppercase">Gestão de Unidades</h1>
          <p className="text-gray-400 font-bold mt-2">Monitore e controle as assinaturas globais.</p>
        </div>
        <div className="flex gap-4">
          <Link to="/super-admin/relatorios" className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black shadow-lg hover:scale-105 transition-all">ESTATÍSTICAS</Link>
          <Link to="/super-admin/planos" className="bg-white border-2 border-gray-100 text-gray-700 px-8 py-4 rounded-2xl font-black hover:border-emerald-500 transition-all">PLANOS</Link>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex gap-2">
           <span className="bg-gray-100 px-6 py-4 rounded-2xl text-[10px] font-black text-gray-400 uppercase tracking-widest">
             Total: {filteredLojas.length} Lojas
           </span>
        </div>
      </div>
      ...
      {selectedIds.length > 0 && (
        <div className="bg-gray-900 text-white p-6 rounded-[2rem] flex items-center justify-between shadow-2xl animate-bounce-in">
          ...
          <div className="p-8 bg-gray-50/50 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className={`px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all ${currentPage === 1 ? 'text-gray-300 cursor-not-allowed' : 'bg-white border border-gray-100 text-gray-600 hover:border-emerald-500 hover:text-emerald-700'}`}
              >
                Anterior
              </button>
              ...
              <button 
                ...
                className={`px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all ${currentPage === totalPages ? 'text-gray-300 cursor-not-allowed' : 'bg-white border border-gray-100 text-gray-600 hover:border-emerald-500 hover:text-emerald-700'}`}
              >
                Próximo
              </button>
            </div>
