...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <section className="pt-20 pb-32 px-6 text-center max-w-6xl mx-auto">
        ...
        <h1 className="text-6xl md:text-9xl font-black text-gray-900 leading-[0.9] tracking-tighter mb-12">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter leading-tight">
                Pare de perder <br/> lucro para os <span className="text-emerald-600">Apps.</span>
              </h2>
              <div className="space-y-10">
                <div className="bg-white p-10 rounded-[2.5rem] shadow-sm">
                  ...
                  <input type="range" min="10" max="500" step="5" value={ticket} onChange={e => setTicket(Number(e.target.value))} className="w-full h-3 bg-gray-100 rounded-lg appearance-none accent-emerald-600" />
                </div>
                <div className="bg-white p-10 rounded-[2.5rem] shadow-sm">
                  <div className="flex justify-between mb-4">
                  ...
                  <input type="range" min="10" max="2000" step="10" value={pedidos} onChange={e => setPedidos(Number(e.target.value))} className="w-full h-3 bg-gray-100 rounded-lg appearance-none accent-emerald-600" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-emerald-900 text-white rounded-[3.5rem] p-16 shadow-3xl text-center relative overflow-hidden">
               ...
               <h3 className="text-6xl md:text-8xl font-black mb-10 tracking-tighter">{formatCurrency(roiExtra)}</h3>
               <p className="text-emerald-100/60 font-medium text-lg">Este é o valor que você recupera todos os meses usando nossa plataforma de canal direto.</p>
               <button onClick={() => navigate('/onboarding')} className="mt-12 w-full bg-emerald-500 hover:bg-emerald-400 text-white py-6 rounded-[2rem] font-black text-xl shadow-xl transition-all">QUERO ECONOMIZAR</button>
            </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
            {planosPublicos.map(plan => (
                <div key={plan.id} className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm flex flex-col items-center text-center">
      ...
      <footer className="py-20 bg-white border-t border-gray-50 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          <div className="col-span-2">
            ...
            <p className="text-gray-400 font-medium text-lg max-w-sm">A solução completa de delivery para quem quer ser dono da própria operação.</p>
          </div>
          <div>
          ...
          <div className="flex flex-col items-end justify-between">
             <div className="bg-[#25D366] text-white px-8 py-4 rounded-2xl font-black shadow-lg cursor-pointer">WHATSAPP VENDAS</div>
